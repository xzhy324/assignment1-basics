...
def run_linear(
    ...
    from cs336_basics.modules.linear import run_linear as run_linear_impl
...
def run_embedding(
    ...
    from cs336_basics.modules.embedding import run_embedding as run_embedding_impl

    return run_embedding_impl(vocab_size, d_model, weights, token_ids)
...
def run_multihead_self_attention(
    ...
    """
    from cs336_basics.modules.multihead_self_attention import (
        run_multihead_self_attention as run_multihead_self_attention_impl,
    )

    return run_multihead_self_attention_impl(
        d_model,
        num_heads,
        q_proj_weight,
        k_proj_weight,
...
def run_multihead_self_attention_with_rope(
    ...
    """
    from cs336_basics.modules.multihead_self_attention import (
        run_multihead_self_attention_with_rope as run_multihead_self_attention_with_rope_impl,
    )

    return run_multihead_self_attention_with_rope_impl(
        d_model,
        num_heads,
        max_seq_len,
        theta,
...
def run_transformer_block(
    ...
    """
    from cs336_basics.modules.transformer_block import (
        run_transformer_block as run_transformer_block_impl,
    )

    return run_transformer_block_impl(
...
def run_get_batch(
    ...
    """
    from cs336_basics.sample_from_dataset import get_batch
...
def run_cross_entropy(
    ...
    """
    from cs336_basics.functions.cross_entropy import run_cross_entropy as run_cross_entropy_impl

    return run_cross_entropy_impl(inputs, targets)
...
def run_get_lr_cosine_schedule(
    ...
    """
    from cs336_basics.optimizers.lr_cosine_schedule import lr_cosine_schedule
...
def run_save_checkpoint(
    ...
    """
    from cs336_basics.checkpoint import save_checkpoint as save_checkpoint_impl
    
    return save_checkpoint_impl(model, optimizer, iteration, out)
...
def run_load_checkpoint(
    ...
    """
    from cs336_basics.checkpoint import load_checkpoint as load_checkpoint_impl
    
    return load_checkpoint_impl(src, model, optimizer)
